...
import fastBPE
import platform
from CTRL.control_codes import CONTROL_CODES
import CTRL.transformer
...
def generate_content(control_codes, key_words):
    # tokenize provided prompt
    split_prompt = ' \n '.join(bpe.apply(control_codes+key_words))
...
if __name__ == "__main__":
    ...
    key_words = 'big job'
    generate_content(control_codes,key_words)
